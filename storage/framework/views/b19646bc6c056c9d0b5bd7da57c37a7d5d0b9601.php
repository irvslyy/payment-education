...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('aset/css/icons/fontawesome/styles.min.css')); ?>">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
						<img src="<?php echo e(asset('aset/images/placeholders/placeholder.jpg')); ?>" class="rounded-circle mr-2" height="34" alt="">
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="<?php echo e(asset('aset/images/placeholders/placeholder.jpg')); ?>" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="<?php echo e(route('siswa.index')); ?>" class="nav-link">Siswa</a></li>
								<li class="nav-item"><a href="<?php echo e(route('petugas.index')); ?>" class="nav-link">Petugas</a></li>
							</ul>
						</li>
						
                        <li class="nav-item"><a href="<?php echo e(route('chart.index')); ?>" class="nav-link"><i class="icon-chart"></i> <span>Reporting chart</span></a></li>
                        <li class="nav-item"><a href="<?php echo e(route('pembayaran.index')); ?>" class="nav-link"><i class="icon-paypal"></i> <span>Pembayaran</span></a></li>
                        <li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-users"></i> <span>users management</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="<?php echo e(route('user.index')); ?>" class="nav-link">users</a></li>
							</ul>
						</li>
                        <li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="<?php echo e(route('history.index')); ?>" class="nav-link">history pembayaran</a></li>
                                <li class="nav-item"><a href="<?php echo e(route('transaksi.index')); ?>" class="nav-link">Transaksi</a></li>
							</ul>
						</li>
                        <li class="nav-item"><a href="<?php echo e(route('setting.index')); ?>" class="nav-link"><i class="icon-cog2"></i> <span>Setting SPP</span></a></li>

                        <li class="nav-item"><a href="<?php echo e(route('trash.index')); ?>" class="nav-link"><i class="icon-trash"></i> <span>Trash</span></a></li>
...
</html><?php /**PATH /root/Documents/UN/report/resources/views/layouts/app.blade.php ENDPATH**/ ?>