...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html"><img src="<?php echo e(asset('img/logo-dark.png')); ?>" alt="Klorofil Logo" class="img-responsive logo"></a>
            </div>
  ...
  <!--               <div class="navbar-btn navbar-btn-right">
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="<?php echo e(url('home')); ?>" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
...
<?php /**PATH /root/Documents/UN/report/resources/views/layouts/app.blade.php ENDPATH**/ ?>