            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="left">
                        <div class="content">
                            <div class="header">
                                <!-- <div class="logo text-center"><img src="<?php echo e(asset('img/tb.png')); ?>" alt="Klorofil Logo" width="50%"></div> -->
...
endif; ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="nama">
...
<?php /**PATH /root/Documents/UN/report/resources/views/auth/register.blade.php ENDPATH**/ ?>